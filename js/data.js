  ...
  menuSections: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Dopiaza",
          description: "Beef stew served with sauteed onions."
        },
        {
          name: "Kofta",
          description: "Seasoned meatballs served in a savory sauce."
        },
        {
          name: "Borani Banjan",
        ...
        {
          name: "Kado Borani",
          description: "Roasted squash in a rich Afghan-style sauce."
        },
        {
          name: "Sabzi",
          description: "Spinach dish simmered in cilantro, garlic and various spices."
        },
        {
          name: "Afghani Macaroni",
          description: "Pasta layered with meat sauce, garlic yogurt with herbs."
        }
      ]
    },
    {
      ...
      items: [
        {
          name: "Chicken Kebab",
          description: "Grilled marinated chicken with bold Afghan spices."
        },
        {
          name: "Chapli Kebab",
          description: "Flavorful flat meat patty mixed with Afghan spices."
        }
      ]
    },
    {
      ...
      items: [
        {
          name: "Firni",
          description: "Traditional creamy Afghan dessert."
        }
      ]
    },
  ],
